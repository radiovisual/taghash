...
describe("taghash", function(){
    ...
    it('should know how to recover from text it can\'t read', function() {
        var text = '#رمضان مبارک: وزير #اشتاینمایر #افطار می کند با همکار خود @Jzarif از #ایران https://t.co/MSurTL0Mvn';
        assert.equal(taghash(text), text);
    });
});
